...
#update customers set cname='cisneros' where cnum=2008;
...
-- ---------
select distinct cname, rating from customers, orders where orders.cnum=customers.cnum and amt > (select avg(amt) from orders );
